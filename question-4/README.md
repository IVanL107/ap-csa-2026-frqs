...
* I had to be careful not to recalcualte the reference color inside the loop. 
## What I Would Do Differently
* I could've broken the loop early if a tile with a different color was found which would save uncessary iterations.
